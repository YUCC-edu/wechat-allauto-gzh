...
或许，我们需要经常给自己按下“暂停键”，才能更好地继续前行。`
  ...
  product: {
    ...
    content: `::: release
# 春日来信**万物复苏的季节**
<div style="font-size: 14px; color: #666; margin-top: 16px; margin-bottom: 32px;">在时光的缝隙里，寻找一抹温暖的颜色</div>
:::

<div style="display: flex; justify-content: space-between; font-size: 12px; color: #666; font-weight: bold; padding: 0 16px; margin-top: 32px;">
  <span>本期拾遗</span>
  <span style="color: #f59e0b;">👉 左右滑动</span>
</div>
...
在这个快节奏的时代，我们总是在不停地奔跑，却往往忽略了身边的美好。**停下脚步**，深呼吸，你会发现，那些微小的确幸，一直都在。`
  }
};
